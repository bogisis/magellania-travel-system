...
-- Extend estimates table with calculation fields
ALTER TABLE estimates ADD COLUMN show_markup BOOLEAN DEFAULT 1;
ALTER TABLE estimates ADD COLUMN markup_percentage DECIMAL(5,2) DEFAULT 15.00;
ALTER TABLE estimates ADD COLUMN base_total DECIMAL(10,2) DEFAULT 0;
ALTER TABLE estimates ADD COLUMN markup_amount DECIMAL(10,2) DEFAULT 0;
ALTER TABLE estimates ADD COLUMN calculation_version VARCHAR(10) DEFAULT '1.0';
ALTER TABLE estimates ADD COLUMN last_calculated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;
